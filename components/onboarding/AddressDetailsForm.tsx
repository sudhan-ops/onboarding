...
import VerifiedInput from '../ui/VerifiedInput';
...
const AddressDetailsForm: React.FC<AddressDetailsFormProps> = ({ onValidated }) => {
    ...
    const { register, handleSubmit, formState: { errors }, control, setValue, trigger, getValues, reset } = useForm<AddressDetails>({
        resolver: yupResolver<AddressDetails>(addressDetailsSchema),
    ...
    const onSubmit: SubmitHandler<AddressDetails> = (formData) => {
