...
const UniformTable: React.FC<{
    title: string;
    sizes: (LadiesPantsSize | LadiesShirtSize)[];
    // FIX: Changed key type to string to allow any property from LadiesPantsSize or LadiesShirtSize, resolving type errors.
    ...
    const sizeGroups = sizes.reduce((acc, size) => {
        ...
        return acc;
    }, {} as Record<string, (LadiesPantsSize | LadiesShirtSize)[]>);
