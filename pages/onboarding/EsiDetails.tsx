                ...
                <div className="space-y-4">
                    ...
                    {hasEsi && (
                         <div className="space-y-4 animate-fade-in-down">
                            <input placeholder="ESI Number" {...register('esiNumber')} className="fo-input"/>
                            <input type="date" {...register('esiRegistrationDate')} className="fo-input"/>
                            <input placeholder="ESIC Branch" {...register('esicBranch')} className="fo-input"/>
                            <Controller name="document" control={control} render={({ field }) => (
                                <UploadDocument label="Upload ESI Card" file={field.value} onFileChange={field.onChange} allowCapture/>
                            )}/>
                        </div>
                    )}
                </div>
