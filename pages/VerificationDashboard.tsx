...
import { Search, Eye, Download, Send, CheckCircle, XCircle, RefreshCw } from 'lucide-react';
                                ...
                                <tr key={s.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div className="flex items-center gap-2">
                                            <Button variant="icon" size="sm" onClick={() => navigate(`/onboarding/add/personal?id=${s.id}`)} title="View Details"><Eye className="h-4 w-4" /></Button>
                                            <Button variant="icon" size="sm" onClick={() => navigate(`/insurance-card/${s.id}`)} title="Download Insurance PDF"><Download className="h-4 w-4" /></Button>
                                            {s.status === 'pending' && (
                                                <>
                                                 <Button variant="icon" size="sm" onClick={() => handleAction('approve', s.id!)} title="Verify"><CheckCircle className="h-4 w-4 text-green-600"/></Button>
                                                 <Button variant="icon" size="sm" onClick={() => handleAction('reject', s.id!)} title="Request Changes"><XCircle className="h-4 w-4 text-red-600"/></Button>
                                                </>
                                            )}
